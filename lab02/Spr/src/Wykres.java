...
public class Wykres extends JFrame {
    ...
    private static final String[] LEGENDS = {"Bez wyboru elementu podstawowego", "Z wyborem elementu podstawowego",
            "Z biblioteki"};
    ...
    public Wykres(double[][] data, double[] xStart, boolean logarithmic) {
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("Średni błąd wektora wynikowego powiększony o 10^10",
                "iteracje", "błąd bezwzględny", dataset,
